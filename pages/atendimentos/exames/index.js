			...
			<Main>
				...
				<MainContent>
					<div className="d-flex justify-content-between top-container mb-4">
						<Link href={`/atendimentos/exames/add`} replace>
							<button type="button" className="btn btn-sm btn-outline-primary">
								Novo Atendimento SP/SADT
							</button>
						</Link>
					</div>
					<div className="card">
							...
							<div className="list-search overflow-auto">
								<div className="list-group">
									{exames.map((exame) => (
										<Link
											key={exame.id}
											href={`/atendimentos/exames/${exame.id}`}
											replace
										>
											<a
											...
											>
												<div className="d-flex w-100 justify-content-between align-items-center">
													<h6 className="mb-1">
														<label>Nome: {exame.paciente}</label>
														<br />
														<small>Usuário: {exame.medico}</small>
													</h6>
												</div>
												<div className="d-flex w-100 justify-content-between align-items-center">
													<p className="mb-1">
														<label>Tipo: {exame.especialidade}</label>
														<br />
														<label>Data: {exame.dataAtendimento}</label>
													</p>
													<small>
														<div
														...
														>
															<Link
																href={`/atendimentos/exames/edit/${exame.id}`}
																replace
															>
																<a
																	type="button"
